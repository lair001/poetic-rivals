module RequestsSpecHelper
	...
	alias_method :expect_unauthorized_action, :expect_unauthorized_access_or_action
	alias_method :expect_unauthorized_access, :expect_unauthorized_access_or_action
